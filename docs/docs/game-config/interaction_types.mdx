...
> 📌 **TODO:**  Add visualization of the control panel for various types of action.
...
![Rendered GUI representation of a Dynamic Property in the simulation interface](./img/dynamicProp.pdf)
...
![Rendered GUI representation of a Stateless Action in the simulation interface](./img/Stateless.pdf)
...
![Rendered GUI representation of a Boolean Action in the simulation interface](./img/Boolean.pdf)
...
![Rendered GUI representation of a Numerical Action in the simulation interface](./img/Numerical.pdf)
...
- [Boolean Action – Example 2: Mode Switch with Visibility Based on Power](#boolean-action--example-2-mode-switch-with-visibility-based-on-power)  
- [Numerical Action – Example 2: Volume Control with Conditional Visibility](#numerical-action--example-2-volume-control-with-conditional-visibility)  

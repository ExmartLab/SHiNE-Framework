...
|--------------------|------------------------------------------------|-----------------------------|
| **Environment**     | Contextual variables that may influence rules | [Environment Schema](/docs/game-config/game_schema/environment) |
| **Rules**           | Automation logic that reacts to environment and devices | [Rules Schema](/docs/game-config/game_schema/rules) |
| **Tasks**           | Experimental tasks with goals, device resets, and timers | [Tasks Schema](/docs/game-config/game_schema/tasks) |
| **Rooms & Walls**   | Visual and navigational layout of the house   | [Walls & Rooms Schema](/docs/game-config/game_schema/walls) |
| **Devices**         | Smart home devices with states and properties | [Devices Schema](/docs/game-config/game_schema/devices) |
| **Device Interaction** | Device action/state schemas (numerical, boolean, etc.) | [Interaction Schema](/docs/game-config/game_schema/interaction_types) |
